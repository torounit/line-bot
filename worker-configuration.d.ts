/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 100a2ec09abff6a9e1435a1a53e0be63)
...
interface __BaseEnv_CloudflareBindings {
	...
	LineChatAgent: DurableObjectNamespace<import("./src/index").LineChatAgent>;
	AI?: Ai;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LineChatAgent";
	}
	interface TestEnv {
		LINE_CHANNEL_ACCESS_TOKEN: string;
		LINE_CHANNEL_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINE_CHANNEL_ACCESS_TOKEN" | "LINE_CHANNEL_SECRET" | "CF_ACCESS_CLIENT_ID" | "CF_ACCESS_CLIENT_SECRET">> {}
}
